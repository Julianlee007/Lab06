...
## The use of similar shades of grey in this makes it hard to distinguish between countries. There are no numerical labels or legends, making it impossible to extract values. It's clear which data corresponds to which dimension. For example is the angle the population density or the total area? Overall there is poor layout and labelling in this chart.
